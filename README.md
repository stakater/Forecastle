...
| `kubernetes.io/ingress.class`                | make sure this annotation is not missing [nginx-ingress](https://kubernetes.github.io/ingress-nginx/user-guide/multiple-ingress/#multiple-ingress-controllers)    | `true`   |
